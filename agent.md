...
This file mirrors `AGENTS.md` for Léa and tools that explicitly look for `agent.md`. Keep both files aligned when these repository-wide instructions change.
