    ...
    public function all(): array
    {
        return [
            [
                ...
                'pathPatterns' => ['~/(jobs?|comm/jobs?)/(?:view/)?~i'],
                'aliases' => ['linkedin'],
            ],
            [
                'code' => 'indeed',
                ...
                'pathPatterns' => ['~/viewjob(?:/|$)~i', '~/rc/clk(?:/|$)~i', '~/jobs?(?:/|$)~i'],
                'aliases' => ['indeed'],
            ],
            [
                'code' => 'apec',
                ...
                'pathPatterns' => ['~/offre(?:/|-|$)~i', '~/recherche-emploi~i', '~/emploi/detail-offre/~i'],
                'aliases' => ['apec'],
            ],
            [
                'code' => 'hellowork',
                ...
                'pathPatterns' => ['~/emplois(?:/|-|$)~i', '~/emploi(?:/|-|$)~i'],
            ...
            [
                ...
                'pathPatterns' => ['~/jobs?(?:/|$)~i', '~/companies/.+/jobs?(?:/|$)~i'],
            ...
            [
                ...
                'pathPatterns' => ['~/tech-it/(?:jobs?|missions?)(?:/|$)~i', '~/missions?(?:/|$)~i', '~/jobs?(?:/|$)~i'],
            ...
            [
                ...
                'pathPatterns' => ['~/missions?(?:/|$)~i', '~/freelance/(?:.+/)?[^/]+(?:/|$)~i'],
            ...
            [
                ...
                'pathPatterns' => ['~/offres?(?:/|$)~i', '~/offres/recherche/detail/~i'],
