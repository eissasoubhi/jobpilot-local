...
La page **Conversion par source** fournit un premier reporting en lecture seule sur les canaux d’acquisition des offres.
...
Une offre canonique peut être présente sur plusieurs sources. Dans ce cas, son offre et sa candidature éventuelle sont attribuées à chacune de ces sources. Les lignes servent à comparer les sources ; elles ne doivent pas être additionnées pour reconstruire le total canonique.
