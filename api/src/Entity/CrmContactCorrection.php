...
final class CrmContactCorrection
{
    ...
    public function getCorrectedName(): ?string { return $this->correctedName; }
    public function getCorrectedEmail(): ?string { return $this->correctedEmail; }
    public function getCorrectedPhone(): ?string { return $this->correctedPhone; }
    ...
    public function update(mixed $name, mixed $email, mixed $phone): self
    {
        ...
        if ($phone !== null && (mb_strlen($phone) > 64 || preg_match('/[\r\n]/u', $phone) === 1 || preg_match('/\d/u', $phone) !== 1)) {
    ...
    {
        return $this->correctedName === null && $this->correctedEmail === null && $this->correctedPhone === null;
    }
